...
import edu.iis.powp.adapter.FigurePlotterAdapter;
...
public class TestPlotSoftPatterns
{
	...
	private static void setupDrivers(Context context) {
		...
		IPlotter plotter = new FigurePlotterAdapter(ApplicationWithDrawer.getDrawPanelController());
		context.addDriver("Not-Buggy Simulator", plotter);
